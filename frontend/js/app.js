...
const translations = {
    tr: {
        ...
        "coming-soon-badge-txt": "YENİ AKTİF",
        "upcoming-features-title": "Gelişmiş E-Ticaret Analizi",
        "upcoming-feat-1": "Linkten Otomatik Görsel ve Veri Alma",
        "upcoming-feat-2": "Gerçek Alıcı Yorumları & Sentiment Analizi",
        "upcoming-feat-3": "En Uygun Bütçeli Alternatifi Bulma (Yakında)",
        "upcoming-feat-4": "Kombinlerde Satın Alma Linkleri (Yakında)",
    ...
    en: {
        ...
        "coming-soon-badge-txt": "NEWLY ACTIVE",
        "upcoming-features-title": "Advanced E-Commerce Analysis",
        "upcoming-feat-1": "Auto Visual & Data Extraction via Link",
        "upcoming-feat-2": "Real Buyer Reviews & Sentiment Analysis",
        "upcoming-feat-3": "Find the Best Budget Price (Soon)",
        "upcoming-feat-4": "Direct Purchase Links in Outfits (Soon)",
        ...
        "promo-s2": "Paste the link of the product you like from an e-commerce site or directly upload the garment image.",
